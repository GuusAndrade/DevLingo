...
class _$UnauthorizedFailureImpl implements UnauthorizedFailure {
  const _$UnauthorizedFailureImpl({required this.message, this.statusCode});
  ...
  @override
  String toString() {
    return 'AppFailure.unauthorized(message: $message, statusCode: $statusCode)';
  }
...
abstract class UnauthorizedFailure implements AppFailure {
