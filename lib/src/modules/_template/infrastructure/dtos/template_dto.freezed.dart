...
abstract class $TemplateDtoCopyWith<$Res> {
  factory $TemplateDtoCopyWith(
    TemplateDto value,
    $Res Function(TemplateDto) then,
  ) = _$TemplateDtoCopyWithImpl<$Res, TemplateDto>;
  @useResult
  $Res call({String id, String name, DateTime createdAt, String? description});
}
...
abstract class _$$TemplateDtoImplCopyWith<$Res>
  ...
  factory _$$TemplateDtoImplCopyWith(
    _$TemplateDtoImpl value,
    $Res Function(_$TemplateDtoImpl) then,
...
class __$$TemplateDtoImplCopyWithImpl<$Res>
  ...
  __$$TemplateDtoImplCopyWithImpl(
    _$TemplateDtoImpl _value,
    $Res Function(_$TemplateDtoImpl) _then,
  ) : super(_value, _then);
...
class _$TemplateDtoImpl implements _TemplateDto {
  ...
  @override
  String toString() {
    return 'TemplateDto(id: $id, name: $name, createdAt: $createdAt, description: $description)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, createdAt, description);
  ...
  Map<String, dynamic> toJson() {
    return _$$TemplateDtoImplToJson(this);
  }
}
